export const projects = [
  ...
  },
  {
    ...
    description:
      "Data-driven reporting platform for construction project management. Aggregates site data, generates automated progress reports, and visualizes KPIs through interactive Power BI dashboards. Built with Python/Pandas for data pipelines and JavaScript for dynamic frontend reporting.",
  ...
  },
  {
    ...
    description:
      "Comprehensive retail analytics dashboard with sales forecasting, inventory optimization, and customer segmentation. Features interactive Power BI visualizations, automated ETL pipelines with Python/Pandas, and a Flask web interface for real-time KPI monitoring.",
  ...
  },
  {
    ...
    description:
      "Intelligent resume screening tool powered by NLP and ML algorithms. Automatically parses resumes, matches candidate profiles to job descriptions with semantic similarity scoring, and ranks applicants. Reduces screening time by 80% using Python, spaCy, and transformer models.",
    tech: ["Python", "NLP", "spaCy", "Flask", "React", "PostgreSQL", "Docker"],
  ...
  },
  {
    ...
    description:
      "Full-featured personal finance management app with expense categorization, budget tracking, portfolio performance analytics, and investment goal projections. Built with React frontend, Spring Boot backend, and PostgreSQL for financial data persistence.",
    tech: ["React", "Java", "Spring Boot", "PostgreSQL", "Chart.js", "REST APIs", "Docker"],
